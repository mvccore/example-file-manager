...
if (!String.prototype.toUnicodeIndexes) {
	String.prototype.toUnicodeIndexes = function () {
		var i = 0, l = 0, result = [];
...
if (!String.prototype.base64Encode) {
	String.prototype.base64Encode = function (encoding) {
...
if (!String.prototype.base64Decode) {
	String.prototype.base64Decode = function (encoding) {
...
if (!Array.prototype.fromUnicodeIndexes) {
	Array.prototype.fromUnicodeIndexes = function () {
